...
high-resolution PNG of the *same view* you just framed in the browser, with
the orbit BFS'd to a much deeper depth than is interactive.

```bash
npm run dev sp6-limit-sets-render
```
