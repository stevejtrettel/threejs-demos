...
const tauHex = new Vector2(1/2,Math.sqrt(3)/2);
...
grp.add(fd.getParallelogram(0xa4e89e));
let grid = fd.getGridlines(15,0x6dc965,0.003,false);
grid.position.set(0,0.01,0);
grp.add(grid);



//get outer edges and vertices
let edges = new Group();
scene.add(edges);

edges.add(fd.getHorizontalAt(0,colors.green,0.02));
edges.add(fd.getHorizontalAt(1,colors.green,0.02));
edges.add(fd.getVerticalAt(0,colors.green,0.02));
edges.add(fd.getVerticalAt(1,colors.green,0.02));
edges.add(fd.getPoint(new Vector2(0,0),0x33852c,0.04));
edges.add(fd.getPoint(new Vector2(1.06,0),0x33852c,0.04));
edges.add(fd.getPoint(tauHex,0x33852c,0.04));
edges.add(fd.getPoint(new Vector2(-1.06,0).add(tauHex),0x33852c,0.04));


scene.add(fd.getPoint(new Vector2(0.55,0.45),0x1e4d1a));
