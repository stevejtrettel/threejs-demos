...
const tauSquare = new Vector2(0,1);


let fd = new FD(tauSquare);
let grp = new Group();
scene.add(grp);

grp.add(fd.getParallelogram(0xedafaf));
let grid = fd.getGridlines(15,0xe38686,0.003,false);
...
edges.add(fd.getHorizontalAt(0,colors.red,0.02));
edges.add(fd.getHorizontalAt(1,colors.red,0.02));
edges.add(fd.getVerticalAt(0,colors.red,0.02));
edges.add(fd.getVerticalAt(1,colors.red,0.02));
edges.add(fd.getPoint(new Vector2(0,0),0xa82c2c,0.04));
edges.add(fd.getPoint(new Vector2(1,0),0xa82c2c,0.04));
edges.add(fd.getPoint(new Vector2(0,1),0xa82c2c,0.04));
edges.add(fd.getPoint(new Vector2(1,1),0xa82c2c,0.04));




scene.add(fd.getPoint(new Vector2(0.6,0.4),0x781919));
