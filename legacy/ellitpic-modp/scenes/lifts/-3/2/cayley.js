...
for(let i=0; i<data.length;i++){
    ...
    points.add(torus.getPoint(pt,0x0f4709,0.04,));
}



//for the group
let gCurve = function(t){
    //get new initial direction: in unit square is 0.3, 0.1
    let dir = torus.fromTauCoords([-0.0384615,0.15544045]);
    return dir.multiplyScalar(40*t);
}
scene.add(torus.getLift(gCurve,colors.yellow,0.01,false));
