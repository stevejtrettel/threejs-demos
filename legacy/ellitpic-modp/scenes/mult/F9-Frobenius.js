...
import Grid2D from "/js/items/Grid2D";
...
let orbit1 = grid.getCurve(f1,colors.green,0.025,false);
scene.add(orbit1);
...
let orbit2 = grid.getCurve(f2,colors.green,0.025,false);
scene.add(orbit2);

//path for i, -i
let orbit3 = grid.getRod([0,1],[0,-1],colors.green,0.025,false);
scene.add(orbit3);

//path for for 1+i, -1+i
let orbit4 = grid.getBentRod([1,1],[-1,1], new Vector3(0,0,0.3),colors.green,0.025,false);
scene.add(orbit4);


//path for for 1-i, -1-i
let orbit5 = grid.getBentRod([1,-1],[-1,-1], new Vector3(0,0,-0.3),colors.green,0.025,false);
scene.add(orbit5);
