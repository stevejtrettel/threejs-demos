...
let surf = torus.getSurface(0xaceba7,true);
scene.add(surf);


//get the real points
//should be OPP EDGE
//but edge vs opp edge are symmetric on the rhombus
//our embedding in euclidean space looks better if we take edge
let realCurve = torus.getOppEdgeAt(0.75,0x2e7028,0.02,false);
scene.add(realCurve);


//add in the marked point
scene.add(torus.getPoint(new Vector2(-1.57,0),0x22521d,0.03));
