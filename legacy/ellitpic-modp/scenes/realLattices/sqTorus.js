...
let surf = torus.getSurface(0xe38686,true);
scene.add(surf);
...
let realCurve = torus.getEdgeAt(0,colors.red,0.05);
scene.add(realCurve);

let realCurve2 = torus.getEdgeAt(0.5,colors.red,0.05);
scene.add(realCurve2);


// //add in the marked point
scene.add(torus.getPoint(new Vector2(1,1),0x9c2828,0.06));
...
// }
// scene.add(torus.getLift(real1,colors.green,0.04,false,true));
//
...
//
// //add in the marked point
// scene.add(torus.getPoint(new Vector2(4,0),0x9c2828,0.06));
//
